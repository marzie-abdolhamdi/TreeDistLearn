...
EDGE_FEATURE_DIM = 12
PRIOR_LAM_B      = 5.0   # Exp(5) prior on branch lengths -> prior mean = 0.2 sub/site
...
def choose_action_ca(
    ...
    if sample_continuous:
        ...
        # Clamp log-space to log(2.0) to enforce max 2.0, and linear space to min 1e-8
        chosen_b = max(1e-8, math.exp(min(mu_b_i.item(), math.log(2.0))))
