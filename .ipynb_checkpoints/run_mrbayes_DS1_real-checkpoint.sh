...
FASTA="data/DS1/DS1_reordered_tree.fasta"
NEXUS="data/DS1/DS1_for_mb.nex"
LOG="data/DS1/DS1_mb.log"
...
fasta     = "data/DS1/DS1_reordered_tree.fasta"
nexus_out = "data/DS1/DS1_for_mb.nex"
...
cd data/DS1
nohup mb DS1_for_mb.nex > DS1_mb.log 2>&1 &
MB_PID=$!
cd ../..
echo "MrBayes running — PID: $MB_PID"
echo "Monitor with:  tail -f data/DS1/DS1_mb.log"
echo ""
echo "Watch convergence diagnostics live (printed every 10000 generations):"
echo "  grep 'Average standard deviation' data/DS1/DS1_mb.log"
...
grep "PSRF" data/DS1/DS1_mb.log | tail -20
echo ""
echo "Average standard deviation of split frequencies (want < 0.01):"
grep "Average standard deviation" data/DS1/DS1_mb.log | tail -5
echo ""
echo "Output files:"
echo "  data/DS1/DS1_for_mb.nex.trprobs   ← topology probabilities"
echo "  data/DS1/DS1_for_mb.nex.run1.t    ← MCMC tree samples"
echo ""
